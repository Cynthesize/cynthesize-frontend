...
export const GRAPHQL_URL = 'https://cynthesize-develop.herokuapp.com/v1alpha1/graphql';
export const REALTIME_GRAPHQL_URL = 'wss://cynthesize-develop.herokuapp.com/v1alpha1/graphql';
